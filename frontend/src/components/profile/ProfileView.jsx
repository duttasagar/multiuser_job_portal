...
export default function ProfileView({ profile, loadProfile }) {
  ...
  // Generate initials when profile image is not available
            ...
            <div className="flex justify-center -mt-10">
              <div className="relative">
                ...
                {profileImage ? (
                  ...
                  <div className="w-24 h-24 rounded-full border-4 border-white shadow-md bg-blue-100 text-blue-600 flex items-center justify-center text-2xl font-bold">
                    {initials}
                  </div>
                )}
